...
save(bench.adj, file = paste0('Betabinomial/NMR/adm1_', time_mod, '_strat_nmr_benchmarks.rda'))
...
bench.adj$ratio <- bench.adj$est/bench.adj$igme
save(bench.adj, file = paste0('Betabinomial/NMR/adm2_', time_mod, '_strat_nmr_benchmarks.rda'))
...
bench.adj$ratio <- bench.adj$est/bench.adj$igme
save(bench.adj, file = paste0('Betabinomial/U5MR/adm1_', time_mod, '_strat_u5_benchmarks.rda'))
...
bench.adj$ratio <- bench.adj$est/bench.adj$igme
save(bench.adj, file = paste0('Betabinomial/U5MR/adm2_', time_mod, 'strat_u5_benchmarks.rda'))
...
bb.adm2.strat.u5.bench <- getBB8(mod.dat, country, beg.year=beg.year, end.year=end.proj.year,
                                 Amat=admin2.mat, admin.level='Admin2',
                                 stratified=T, weight.strata=weight.strata.adm2.u5,
                                 outcome='u5mr', time.model=time_mod, st.time.model=time_mod,
                                 adj.frame=adj.frame.bench, adj.varnames=adj.varnames,
                                 nsim = 1000)
...
bench.adj$ratio <- bench.adj$est/bench.adj$igme
save(bench.adj, file = paste0('Betabinomial/NMR/adm1_', time_mod, '_unstrat_nmr_benchmarks.rda'))
...
sink(file=paste0('Betabinomial/NMR/',country,'_fit_adm1_',
time_mod, 'unstrat_nmr_allsurveys_bench.txt'))
summary(bb.fit.adm1.unstrat.nmr.allsurveys.bench)
sink(file=NULL)
# save smaller components of fit
save(bb.temporals.adm1.unstrat.nmr.allsurveys.bench,
     file=paste0('Betabinomial/NMR/',country,'_temporals_adm1_',
     time_mod, '_unstrat_nmr_allsurveys_bench.rda'))
save(bb.hyperpar.adm1.unstrat.nmr.allsurveys.bench,
     file=paste0('Betabinomial/NMR/', country,'_hyperpar_adm1_',
     time_mod, '_unstrat_nmr_allsurveys_bench.rda'))
save(bb.fixed.adm1.unstrat.nmr.allsurveys.bench,
     file=paste0('Betabinomial/NMR/',country,'_fixed_adm1_',
     time_mod, '_unstrat_nmr_allsurveys_bench.rda'))
# save results
save(bb.res.adm1.unstrat.nmr.allsurveys.bench,
     file=paste0('Betabinomial/NMR/',country,'_res_adm1_',
     time_mod, '_unstrat_nmr_allsurveys_bench.rda'))
...
bench.adj$ratio <- bench.adj$est/bench.adj$igme
save(bench.adj, file = paste0('Betabinomial/NMR/adm2_', time_mod, '_unstrat_nmr_benchmarks.rda'))
...
# save summary of fit to a txt file
sink(file=paste0('Betabinomial/NMR/',country,'_fit_adm2_', time_mod, '_unstrat_nmr_allsurveys_bench.txt'))
summary(bb.fit.adm2.unstrat.nmr.allsurveys.bench)
sink(file=NULL)
# save smaller components of fit
save(bb.temporals.adm2.unstrat.nmr.allsurveys.bench,
     file=paste0('Betabinomial/NMR/',country,'_temporals_adm2_', time_mod, 
                 '_unstrat_nmr_allsurveys_bench.rda'))
save(bb.hyperpar.adm2.unstrat.nmr.allsurveys.bench,
     file=paste0('Betabinomial/NMR/',country,'_hyperpar_adm2_', time_mod, 
                 '_unstrat_nmr_allsurveys_bench.rda'))
save(bb.fixed.adm2.unstrat.nmr.allsurveys.bench,
     file=paste0('Betabinomial/NMR/',country,'_fixed_adm2_',
                 time_mod, '_unstrat_nmr_allsurveys_bench.rda'))
# save results
save(bb.res.adm2.unstrat.nmr.allsurveys.bench,
     file=paste0('Betabinomial/NMR/',country,'_res_adm2_', 
                 time_mod, '_unstrat_nmr_allsurveys_bench.rda'))
...
bench.adj$ratio <- bench.adj$est/bench.adj$igme
save(bench.adj, file = paste0('Betabinomial/U5MR/adm1_', time_mod, '_unstrat_u5_benchmarks.rda'))
...
sink(file=paste0('Betabinomial/U5MR/',country,'_fit_adm1_', time_mod, 
                 '_unstrat_u5_allsurveys_bench.txt'))
summary(bb.fit.adm1.unstrat.u5.allsurveys.bench)
sink(file=NULL)
# save smaller components of fit
save(bb.temporals.adm1.unstrat.u5.allsurveys.bench,
     file=paste0('Betabinomial/U5MR/',country,'_temporals_adm1_',
     time_mod, '_unstrat_u5_allsurveys_bench.rda'))
save(bb.hyperpar.adm1.unstrat.u5.allsurveys.bench,
     file=paste0('Betabinomial/U5MR/',country,'_hyperpar_adm1_', time_mod,
     '_unstrat_u5_allsurveys_bench.rda'))
save(bb.fixed.adm1.unstrat.u5.allsurveys.bench,
     file=paste0('Betabinomial/U5MR/',country,'_fixed_adm1_',
                 time_mod, '_unstrat_u5_allsurveys_bench.rda'))
# save results
save(bb.res.adm1.unstrat.u5.allsurveys.bench,
     file=paste0('Betabinomial/U5MR/',country,'_res_adm1_', time_mod,
     '_unstrat_u5_allsurveys_bench.rda'))
...
bench.adj$ratio <- bench.adj$est/bench.adj$igme
save(bench.adj, file = paste0('Betabinomial/U5MR/adm2_', time_mod, '_unstrat_u5_benchmarks.rda'))
...
# save summary of fit to a txt file
sink(file=paste0('Betabinomial/U5MR/',country,'_fit_adm2_',
                 time_mod, '_unstrat_u5_allsurveys_bench.txt'))
summary(bb.fit.adm2.unstrat.u5.allsurveys.bench)
sink(file=NULL)
# save smaller components of fit
save(bb.temporals.adm2.unstrat.u5.allsurveys.bench,
     file=paste0('Betabinomial/U5MR/',country,'_temporals_adm2_',
     time_mod,'_unstrat_u5_allsurveys_bench.rda'))
save(bb.hyperpar.adm2.unstrat.u5.allsurveys.bench,
     file=paste0('Betabinomial/U5MR/',country,'_hyperpar_adm2_',
     time_mod, '_unstrat_u5_allsurveys_bench.rda'))
save(bb.fixed.adm2.unstrat.u5.allsurveys.bench,
     file=paste0('Betabinomial/U5MR/',country,'_fixed_adm2_', time_mod,
     '_unstrat_u5_allsurveys_bench.rda'))
# save results
save(bb.res.adm2.unstrat.u5.allsurveys.bench,
     file=paste0('Betabinomial/U5MR/',country,'_res_adm2_', time_mod,
     '_unstrat_u5_allsurveys_bench.rda'))

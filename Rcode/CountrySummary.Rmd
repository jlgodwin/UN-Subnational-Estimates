...
## ONLY NEED TO DO IF USING MAC -- change user path to that of your local computer
# user.path <- "/Users/alanamcgovern"
# home.dir <- gsub('~',user.path,home.dir)
...
```{r}
if(exists('poly.layer.adm2')){
  cat(country, ' has ', nrow(admin1.names), ' Admin 1 areas and ', nrow(admin2.names), 'Admin 2 areas.')
}else{
   cat(country, ' has ', nrow(admin1.names), ' Admin 1 areas.')
}
```

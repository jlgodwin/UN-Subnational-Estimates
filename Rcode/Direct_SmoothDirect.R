...
for(survey in survey_years){
  ...
  births.list[[svy.idx]]$period <- 
    as.character(cut(births.list[[svy.idx]]$years, 
                     breaks = c(beg.period.years,
                                beg.period.years[length(beg.period.years)]+5),
  ...
  births.list.nmr[[svy.idx]]$period <- 
    as.character(cut(births.list.nmr[[svy.idx]]$years,
                     breaks = c(beg.period.years,
                                beg.period.years[length(beg.period.years)]+5),
                     include.lowest = T, right = F, labels = periods)) # generate period label 
}
...
if(length(births.list) != 1){
  ...
  direct.natl.nmr <-  SUMMER::getDirectList(births.list.nmr, periods,
                                            ...
                                            national.only = T)
  # yearly estimates
  direct.natl.yearly.u5 <- SUMMER::getDirectList(births.list, 
                                                 beg.year:end.year,
                                                 regionVar = "admin1.char",
                                                 timeVar = "years", 
                                                 clusterVar =  "~cluster",
                                                 ...
                                                 weightsVar = "v005",
                                                 national.only = T)
  direct.natl.yearly.nmr <- SUMMER::getDirectList(births.list.nmr,
                                                  beg.year:end.year,
                                                  regionVar = "admin1.char",
                                                  timeVar = "years", 
                                                  clusterVar =  "~cluster",
  ...
  direct.natl.nmr <-  SUMMER::getDirect(as.data.frame(births.list.nmr[[1]]),
                                        periods,
                                        regionVar = "admin1.char",
                                        timeVar = "period", 
                                        clusterVar =  "~cluster",
                                        ...
                                        weightsVar = "v005",national.only = T)
  # yearly estimates
  direct.natl.yearly.u5 <-  SUMMER::getDirect(as.data.frame(births.list[[1]]),
                                              beg.year:end.year,
                                              regionVar = "admin1.char",
                                              timeVar = "years", 
                                              clusterVar =  "~cluster",
                                              ...
                                              weightsVar = "v005",
                                              national.only = T)
  direct.natl.yearly.nmr <-  
    SUMMER::getDirect(as.data.frame(births.list.nmr[[1]]), beg.year:end.year,
                      regionVar = "admin1.char",
                      timeVar = "years", 
                      clusterVar =  "~cluster",
                      ageVar = "age", Ntrials = "total",
  ...
  direct.natl.u5$survey <- direct.natl.nmr$survey <-
    direct.natl.yearly.u5$survey <- direct.natl.yearly.nmr$survey <- 1
  direct.natl.u5$surveyYears <- direct.natl.nmr$surveyYears <- 
    direct.natl.yearly.u5$surveyYears <- direct.natl.yearly.nmr$surveyYears <- 
    survey_years[1]
  direct.natl.u5$region_num <- direct.natl.u5$region
  direct.natl.nmr$region_num <- direct.natl.nmr$region
  direct.natl.yearly.u5$region_num <- direct.natl.yearly.u5$region
...
save(direct.natl.yearly.u5, file = paste0('U5MR/',country,
                                          '_direct_natl_yearly_u5.rda'))
save(direct.natl.nmr, file = paste0('NMR/',country, '_direct_natl_nmr.rda'))
save(direct.natl.yearly.nmr, file = paste0('NMR/',country,
                                           '_direct_natl_yearly_nmr.rda'))
...
if(length(births.list) != 1){
  direct.admin1.u5 <-  SUMMER::getDirectList(births.list, periods,
                                             ...
                                             weightsVar = "v005",
                                             national.only = F)
  direct.admin1.yearly.u5 <- SUMMER::getDirectList(births.list, 
                                                   beg.year:end.year,
                                                   regionVar = "admin1.char",
                                                   timeVar = "years", 
                                                   clusterVar =  "~cluster",
                                                   ...
                                                   national.only = F)
  direct.admin1.nmr <-  
    SUMMER::getDirectList(births.list.nmr, periods,
                          regionVar = "admin1.char",
                          timeVar = "period", 
                          clusterVar =  "~cluster",
                          ageVar = "age", Ntrials = "total",
  ...
  direct.admin1.yearly.nmr <- 
    SUMMER::getDirectList(births.list.nmr, beg.year:end.year,
                          regionVar = "admin1.char",
                          timeVar = "years", 
                          clusterVar =  "~cluster",
                          ageVar = "age", Ntrials = "total",
  ...
  direct.admin1.u5 <-  
    SUMMER::getDirect(as.data.frame(births.list[[1]]), periods,
                      regionVar = "admin1.char",
                      timeVar = "period", 
                      clusterVar =  "~cluster",
                      ageVar = "age", Ntrials = "total",
  ...
  direct.admin1.yearly.u5 <-  
    SUMMER::getDirect(as.data.frame(births.list[[1]]), beg.year:end.year,
                      regionVar = "admin1.char",
                      timeVar = "years", 
                      clusterVar =  "~cluster",
                      ageVar = "age", Ntrials = "total",
                      weightsVar = "v005",national.only = F)
  direct.admin1.nmr <- 
    SUMMER::getDirect(as.data.frame(births.list.nmr[[1]]), periods,
                      regionVar = "admin1.char",
                      timeVar = "period", 
                      clusterVar =  "~cluster",
                      ageVar = "age", Ntrials = "total",
  ...
  direct.admin1.u5$survey <- direct.admin1.yearly.u5$survey <- 
    direct.admin1.nmr$survey <- direct.admin1.yearly.nmr$survey <- 1
  direct.admin1.u5$surveyYears <- direct.admin1.yearly.u5$surveyYears <- 
    direct.admin1.nmr$surveyYears <- direct.admin1.yearly.nmr$surveyYears <-
    survey_years[1]
...
save(direct.admin1.u5, 
     file = paste0('U5MR/',country, '_direct_admin1_u5.rda'))
save(direct.admin1.yearly.u5, 
     file = paste0('U5MR/',country, '_direct_admin1_yearly_u5.rda'))
save(direct.admin1.nmr,
     file = paste0('NMR/',country, '_direct_admin1_nmr.rda'))
save(direct.admin1.yearly.nmr,
     file = paste0('NMR/',country, '_direct_admin1_yearly_nmr.rda'))
...
if(exists("poly.layer.adm2")){
  ...
  if(length(births.list) != 1){
    direct.admin2.u5 <- 
      SUMMER::getDirectList(births.list, periods,
    ...
    direct.admin2.u5$surveyYears <- 
      direct.admin2.nmr$surveyYears <- survey_years[1]
  ...
  if(length(births.list) != 1){
    direct.admin2.yearly.u5 <-
      SUMMER::getDirectList(births.list, beg.year:end.year,
                            regionVar = "admin2.char",
                            timeVar = "years", 
                            clusterVar =  "~cluster",
                            ageVar = "age", Ntrials = "total",
                            weightsVar = "v005",national.only = F)
    direct.admin2.yearly.nmr <- 
      SUMMER::getDirectList(births.list.nmr, beg.year:end.year,
                            regionVar = "admin2.char",
                            timeVar = "years", 
                            clusterVar =  "~cluster",
    ...
    direct.admin2.yearly.u5$surveyYears <- 
      direct.admin2.yearly.nmr$surveyYears <- survey_years[1]
  ...
  save(direct.admin2.u5, 
       file = paste0('U5MR/',country, '_direct_admin2_u5.rda'))
  save(direct.admin2.yearly.u5, 
       file = paste0('U5MR/',country, '_direct_admin2_yearly_u5.rda'))
  save(direct.admin2.nmr, 
       file = paste0('NMR/',country, '_direct_admin2_nmr.rda'))
  save(direct.admin2.yearly.nmr,
       file = paste0('NMR/',country, '_direct_admin2_yearly_nmr.rda'))
}  
    ...
    for(area in admin1.names$GADM){
      ...
      tmp.adj <- 
        SUMMER::getAdjusted(direct.admin1.yearly.u5[
          direct.admin1.yearly.u5$region == as.character(area.int) &
...
res.natl.u5 <- getSmoothed(fit.natl.u5,
                           year_range = c(beg.year, max(end.proj.years)),
...
save(res.natl.u5, 
     file = paste0('U5MR/',country, 
                   "_res_natl_", time.model, "_u5_SmoothedDirect.rda")) # save the national 3-year smoothed direct U5MR
...
res.natl.nmr <- getSmoothed(fit.natl.nmr,
                            year_range = c(beg.year, max(end.proj.years)),
...
save(res.natl.nmr, file = paste0('NMR/',
                                 country, "_res_natl_",
                                 time.model, "_nmr_SmoothedDirect.rda"))
...
save(res.natl.yearly.u5, file = paste0('U5MR/',country,
                                       "_res_natl_", time.model,
                                       "_yearly_u5_SmoothedDirect.rda")) # save the national yearly smoothed direct U5MR
...
save(res.natl.yearly.nmr,
     file = paste0('NMR/',country,
                   "_res_natl_", time.model, 
                   "_yearly_nmr_SmoothedDirect.rda")) # save the national yearly smoothed direct U5MR
...
res.admin1.u5$years.num <- seq(beg.year,max(end.proj.years),3)[
  match(res.admin1.u5$years, periods)]
res.admin1.u5$region.gadm <- admin1.names$GADM[match(res.admin1.u5$region,
                                                     admin1.names$Internal)]

save(res.admin1.u5,
     file = paste0('U5MR/',country, "_res_admin1_", 
                   time.model, "_u5_SmoothedDirect.rda"))# save the admin1 3-year smoothed direct U5MR
...
fit.admin1.nmr <- smoothDirect(data.admin1.nmr, Amat = admin1.mat,
                               year_label = periods,
                               type.st = 4, time.model = time.model,
                               year_range = c(beg.year, max(end.proj.years)), 
                               is.yearly = F)
...
res.admin1.nmr$years.num <- 
  seq(beg.year,max(end.proj.years),3)[match(res.admin1.nmr$years, periods)]
res.admin1.nmr$region.gadm <- admin1.names$GADM[match(res.admin1.nmr$region,
                                                      admin1.names$Internal)]

save(res.admin1.nmr, 
     file = paste0('NMR/',country, "_res_admin1_",
                   time.model, "_nmr_SmoothedDirect.rda"))# save the admin1 3-year smoothed direct U5MR
...
tryCatch({
  ...
  fit.admin1.yearly.u5 <- 
    smoothDirect(data.admin1.yearly.u5, Amat = admin1.mat,
                 time.model = time.model,
                 year_label = as.character(beg.year:max(end.proj.years)),
                 type.st = 4,
                 year_range = c(beg.year, max(end.proj.years)), is.yearly = F)
  sd.admin1.yearly.u5 <- 
    getSmoothed(fit.admin1.yearly.u5, Amat = admin1.mat,
                year_label = as.character(beg.year:max(end.proj.years)),
                year_range = c(beg.year, max(end.proj.years)),
                save.draws = TRUE)
  sd.admin1.yearly.u5$region.gadm <- 
    admin1.names$GADM[match(sd.admin1.yearly.u5$region, admin1.names$Internal)]
  
  save(sd.admin1.yearly.u5, 
       file = paste0('U5MR/',country, "_res_admin1_",
                     time.model, "_u5_SmoothedDirect_yearly.rda")) # save the admin1 yearly smoothed direct U5MR
  
  ##NMR
  data.admin1.yearly.nmr <- data.admin1.yearly.nmr[data.admin1.yearly.nmr$region!='All',]
  fit.admin1.yearly.nmr <- 
    smoothDirect(data.admin1.yearly.nmr, Amat = admin1.mat, 
                 time.model = time.model,
                 year_label = as.character(beg.year:max(end.proj.years)),
                 type.st = 4,
                 year_range = c(beg.year, max(end.proj.years)), is.yearly = F)
  sd.admin1.yearly.nmr <- 
    getSmoothed(fit.admin1.yearly.nmr, Amat = admin1.mat,
                year_label = as.character(beg.year:max(end.proj.years)),
                year_range = c(beg.year, max(end.proj.years)),
                save.draws = TRUE)
  sd.admin1.yearly.nmr$region.gadm <- 
    admin1.names$GADM[match(sd.admin1.yearly.nmr$region,
                            admin1.names$Internal)]
  
  save(sd.admin1.yearly.nmr,
       file = paste0('NMR/',country, "_res_admin1_", 
...
if(exists("poly.layer.adm2")){
  ...
  fit.admin2.u5 <- 
    smoothDirect(data.admin2.u5, Amat = admin2.mat,
                 year_label = periods,type.st = 4, time.model = time.model,
                 year_range = c(beg.year, max(end.proj.years)), is.yearly = F)
  res.admin2.u5 <- 
    getSmoothed(fit.admin2.u5, Amat = admin2.mat,
                year_label = periods,
                year_range = c(beg.year, max(end.proj.years)),
                save.draws = TRUE)
  
  res.admin2.u5$years.num <- 
    seq(beg.year,max(end.proj.years),3)[match(res.admin2.u5$years, periods)]
  res.admin2.u5$region.gadm <- 
    admin2.names$GADM[match(res.admin2.u5$region, admin2.names$Internal)]
  
  save(res.admin2.u5, 
       file = paste0('U5MR/',country,
                     "_res_admin2_", time.model, "_u5_SmoothedDirect.rda"))
  ...
  fit.admin2.nmr <- 
    smoothDirect(data.admin2.nmr, Amat = admin2.mat,
                 year_label = periods,type.st = 4, time.model = time.model,
                 year_range = c(beg.year, max(end.proj.years)), is.yearly = F)
  res.admin2.nmr <- 
    getSmoothed(fit.admin2.nmr, Amat = admin2.mat,
                year_label = periods,
                year_range = c(beg.year, max(end.proj.years)),
                save.draws = TRUE)
  
  res.admin2.nmr$years.num <- 
    seq(beg.year,max(end.proj.years),3)[match(res.admin2.nmr$years, periods)]
  res.admin2.nmr$region.gadm <-
    admin2.names$GADM[match(res.admin2.nmr$region, admin2.names$Internal)]
  
  save(res.admin2.nmr,
       file = paste0('NMR/',country, "_res_admin2_",
                     time.model, "_nmr_SmoothedDirect.rda"))
...
if(exists("poly.layer.adm2")){
  ##U5MR
  tryCatch({
    data.admin2.yearly.u5 <- 
      data.admin2.yearly.u5[data.admin2.yearly.u5$region!='All',]
    fit.admin2.yearly.u5 <- 
      smoothDirect(data.admin2.yearly.u5, Amat = admin2.mat, time.model = time.model,
                   year_label = as.character(beg.year:max(end.proj.years)),type.st = 4,
                   year_range = c(beg.year, max(end.proj.years)), is.yearly = F)
    sd.admin2.yearly.u5 <- 
      getSmoothed(fit.admin2.yearly.u5, Amat = admin2.mat,
                  year_label = as.character(beg.year:max(end.proj.years)),
                  year_range = c(beg.year, max(end.proj.years)),
                  save.draws = TRUE)
    sd.admin2.yearly.u5$region.gadm <- 
      admin2.names$GADM[match(sd.admin2.yearly.u5$region, 
                              admin2.names$Internal)]
    
    save(sd.admin2.yearly.u5,
         file = paste0('U5MR/',country, "_res_admin2_",
                       time.model, "_u5_SmoothedDirect_yearly.rda")) # save the admin2 yearly smoothed direct U5MR
    
    ##NMR
    data.admin2.yearly.nmr <-
      data.admin2.yearly.nmr[data.admin2.yearly.nmr$region!='All',]
    fit.admin2.yearly.nmr <- 
      smoothDirect(data.admin2.yearly.nmr, Amat = admin2.mat, time.model = time.model,
                   year_label = as.character(beg.year:max(end.proj.years)),type.st = 4,
                   year_range = c(beg.year, max(end.proj.years)), is.yearly = F)
    sd.admin2.yearly.nmr <- 
      getSmoothed(fit.admin2.yearly.nmr, Amat = admin2.mat,
                  year_label = as.character(beg.year:max(end.proj.years)),
                  year_range = c(beg.year, max(end.proj.years)),
                  save.draws = TRUE)
    sd.admin2.yearly.nmr$region.gadm <- 
      admin2.names$GADM[match(sd.admin2.yearly.nmr$region,
                              admin2.names$Internal)]
    
    save(sd.admin2.yearly.nmr,
         file = paste0('NMR/',country, "_res_admin2_",
...
plotagg.admin1.nmr$regionPlot <- 
  admin1.names$GADM[match(plotagg.admin1.nmr$region,
                          admin1.names$Internal)]
...
plotagg.admin1.yearly.u5$regionPlot <- 
  admin1.names$GADM[match(plotagg.admin1.yearly.u5$region,
                          admin1.names$Internal)]
pdf(paste0("Figures/Direct/U5MR/Admin1/",
           country,
...
plotagg.admin1.yearly.nmr$regionPlot <- 
  admin1.names$GADM[match(plotagg.admin1.yearly.nmr$region,
                          admin1.names$Internal)]
pdf(paste0("Figures/Direct/NMR/Admin1/",
           country,
...
direct.natl.u5$cex2 <-
  median(direct.natl.u5$width, na.rm = T)/direct.natl.u5$width
...
direct.natl.nmr$cex2 <-
  median(direct.natl.nmr$width, na.rm = T)/direct.natl.nmr$width
...
## U5MR
direct.natl.yearly.u5$width <- 
  direct.natl.yearly.u5$upper - direct.natl.yearly.u5$lower
direct.natl.yearly.u5$cex2 <- 
  median(direct.natl.yearly.u5$width, na.rm = T)/direct.natl.yearly.u5$width
direct.natl.yearly.u5$cex2[direct.natl.yearly.u5$cex2 > 6] <- 6

if(dim(direct.natl.yearly.u5)[1] != 0 &
   !(sum(is.na(direct.natl.yearly.u5$mean)) == nrow(direct.natl.yearly.u5))){
...
{
  par(mfrow=c(1,1))
  if (nrow(direct.natl.yearly.u5) > 0 &
      sum(is.na(direct.natl.yearly.u5$mean)) == nrow(direct.natl.yearly.u5)) {
    plot(NA, xlab = "Year", ylab = "U5MR",
         ylim = c(0, plot.max), xlim = c(beg.year, max(end.proj.years)),
...
## NMR
direct.natl.yearly.nmr$width <-
  direct.natl.yearly.nmr$upper - direct.natl.yearly.nmr$lower
direct.natl.yearly.nmr$cex2 <- 
  median(direct.natl.yearly.nmr$width, na.rm = T)/direct.natl.yearly.nmr$width
direct.natl.yearly.nmr$cex2[direct.natl.yearly.nmr$cex2 > 6] <- 6

if(dim(direct.natl.yearly.nmr)[1] != 0 & 
   !(sum(is.na(direct.natl.yearly.nmr$mean)) == nrow(direct.natl.yearly.nmr))){
...
{
  par(mfrow=c(1,1))
  if (nrow(direct.natl.yearly.nmr) > 0 & 
      sum(is.na(direct.natl.yearly.nmr$mean)) == nrow(direct.natl.yearly.nmr)) {
    plot(NA, xlab = "Year", ylab = "NMR",
         ylim = c(0, plot.max), xlim = c(beg.year, max(end.proj.years)),
         type = 'l', lwd = 2,col = cols[svy.idx], main = country)
    ...
    height = 6, width = 6)
{
  ...
  plot(NA, xlab = "Year", ylab = "U5MR",
       ylim = c(0, plot.max), xlim = c(beg.year, max(end.proj.years)),
       main = paste0(country,' - Admin 1 Regions'))
  legend('topright', bty = 'n',
  ...
  for(area in 1:dim(poly.adm1)[1]){
    ...
    res.area <- res.admin1.u5[res.admin1.u5$region == 
                                as.character(admin1.names$Internal[area]),]
    ...
    height = 6, width = 6)
{
  ...
  for(area in 1:dim(poly.adm1)[1]){
    ...
    res.area <- res.admin1.nmr[res.admin1.nmr$region ==
                                 as.character(admin1.names$Internal[area]),]
...
if(exists("poly.adm2")){
      ...
      height = 6, width = 6)
  {
    ...
    plot(NA, xlab = "Year", ylab = "U5MR",
         ylim = c(0, plot.max), xlim = c(beg.year, max(end.proj.years)),
         main = paste0(country,' - Admin 2 Regions'))
    ...
    for(area in 1:dim(poly.adm2)[1]){
      ...
      res.area <- res.admin2.u5[res.admin2.u5$region == 
                                  as.character(admin2.names$Internal[area]),]
      ...
      height = 6, width = 6)
  {
    ...
    for(area in 1:dim(poly.adm2)[1]){
      ...
      res.area <- res.admin2.nmr[res.admin2.nmr$region ==
                                   as.character(admin2.names$Internal[area]),]
